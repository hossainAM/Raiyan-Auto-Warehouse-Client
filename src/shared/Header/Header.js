...
const Header = () => {
    return (
        <header className="text-gray-600 bg-red-700 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <NavLink style={({ isActive }) => isActive ? {textDecoration: 'underline'} : undefined} to="/inventory" className="mr-5 text-gray-100 hover:text-gray-900">Inventory</NavLink>
