...
const ContactUs = () => {
    return (
        ...
        <div className="container px-5 py-24 mx-auto">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Our team is here to help our customers with any question or comments. If you would like to get in touch with our team at Raiyan Auto Warehouse, use the contact information on this page. We are always happy to hear from our community members in Dhaka and the surrounding area.</p>
            </div>
            ...
            <div className="flex flex-wrap -m-2">
                ...
                <a className="text-red-500">raiyanauto@gmail.com</a>
                <p className="leading-normal my-5">49 Main St.
                    <br/>Bashundhara, MN 56301
                </p>
